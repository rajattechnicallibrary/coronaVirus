...
SET /P PLATFORM=%Green%Script Written By Rajat Gupta, Choose a PLATFORM [type 'a' for android,'i' for ios or 'w' for windows]%Green% :
...
:CASE_a
  ...
  start ionic cordova run android --device -l --ssl --debug
  GOTO END_CASE
:CASE_i
